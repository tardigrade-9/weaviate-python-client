from typing import Generic, Optional, Type, overload
...
class _NearObjectGroupBy(Generic[Properties], _Query[Properties]):
    @overload
    def near_object(
        self,
        near_object: UUID,
...
class _NearObjectGroupByAsync(Generic[Properties], _Query[Properties]):
    @overload
